...
//Submit Event Handler on Form Submit
    const handleSubmit = (e) =>{
         e.preventDefault();
         axios.post('http://localhost:3001/my-account/signupform', {customer_type,salutation, first_name, last_name, email, password, phone, date_of_birth, country,
                ...
                <div className="col-md-6">
                    ...
                    <hr/>
                        <div className="mb-3">
                            ...
                            <select  type="text" id="customer_type" name="customer_type"  onChange = {(e)=> setCustomerType(e.target.value)} required>
                        ...
                        <div className="mb-3">
                            ...
                            <select type="text" id="salutation" name="salutation" onChange = {(e)=> setSalutation(e.target.value)} required>
                                <option value="">Please choose</option>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text"  className="form-control" id="firstName" name="first_name"  onChange = {(e)=> setFirstName(e.target.value)} required/>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="name"className="form-label">Your  Last Name:</label>
                            <input type="text"  className="form-control" id="lastName" name="last_name"  onChange = {(e)=> setLastName(e.target.value)} required/>
                        </div>
                        <div className="mb-3">
                    ...
                    <div className="row g-2">
                        ...
                        <div className="col-md-4 mb-3">
                            ...
                            <input
                                ...
                                onChange={(e)=> setStreetNumber(e.target.value)} required
                                />
                        </div>
                    </div>
                    <div className="row g-2">
